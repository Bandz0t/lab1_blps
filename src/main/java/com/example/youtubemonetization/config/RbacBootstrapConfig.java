...
public class RbacBootstrapConfig {

    @Qualifier("flywayDataSource")
    private final DataSource dataSource;

    @PostConstruct
    public void ensureRbacSchema() {
    ...
    private java.util.List<String> statements() {
        return java.util.List.of(
                "alter table users add column if not exists password_hash varchar(255) not null default '{noop}change-me'",
                "alter table users add column if not exists role varchar(30) not null default 'AUTHOR'",
                """
                ...
                """,
                "update users set password_hash = '{noop}demo12345', role = 'AUTHOR' where username = 'demo_author'",
                """
